    ...
    <section className="bg-gray-50 py-24 min-h-screen pt-36">
      <div className="max-w-3xl mx-auto px-8">
        ...
        <p className="text-center text-gray-600 mb-10">
          For business inquiries about ERP, POS, FBR integration or custom software — send us a message.
        </p>
        ...
        <div className="text-center mt-8">
          <a
            href="https://wa.me/923001234567?text=Hello%20TeachKaam,%20I%20need%20information%20about%20your%20services."
            target="_blank"
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12 text-center">
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200 hover:shadow-md transition">
            ...
            <a
              href="https://www.google.com/maps/search/?api=1&query=Faisalabad+Pakistan"
              target="_blank"
              rel="noopener noreferrer"
              className="text-red-600 text-sm font-semibold hover:underline"
            >
              Faisalabad, Pakistan (View Map)
            </a>
          </div>
